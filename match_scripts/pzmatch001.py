...
def match(out_matches, out_NOmatches, upp, count_file):	
    ...
    root_masterpzc = '/Users/Harry/M101/PZ_NOmatches2GAMA.csv'	
    root_GAMAcut_cat = '/Users/Harry/M101/GAMA_SDSScatalog.csv'	
    ...
    intervals = np.arange(start=0, stop=len_pzc, step=len_pzc/50, dtype=np.int64)	
...
if __name__ == '__main__':	
    upp = 1
    out_matches = '/Users/Harry/M101/SplitMatchRun/PZvGAMA_match' + str(upp) + '.csv'	
    out_NOmatches = '/Users/Harry/M101/SplitMatchRun/PZvGAMA_NOmatch' + str(upp) + '.csv'	
    count_file = '/Users/Harry/M101/SplitMatchRun/count' + str(upp) + '.txt'	
